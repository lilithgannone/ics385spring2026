...
//manually altered, AI assisted for the intitial structuring of the component. I needed assistance understanding what was required for the ({name, description, tip}) => { ... } syntax. Styling manually coded.
