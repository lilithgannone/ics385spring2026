...
## AI Disclosure
Generated with the help of ChatGPT and Codex. I handled all of the planning and file structure changes. Please see the reflection for details. I also handled the majority of coding entries for this portion of the assignment (Week 13), but I used ChatGPT and Codex to help with brainstorming, structuring the project, writing complex code, error resolution, updating some jsx files, and refining the content. The CSS styling was primarily done with AI assistance, although some of it I manually edited after generation to fix specific issues (font sizing, margin issues, etc). 
