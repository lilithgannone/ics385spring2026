    ...
    <section className="dashboard-cta">
      <div className="dashboard-cta-media">
        <div className="stream-frame" aria-hidden="true">
          <iframe
            src="https://www.youtube.com/embed/Umlf7-iBlKQ?autoplay=1&mute=1&controls=0&disablekb=1&modestbranding=1&playsinline=1&loop=1&playlist=Umlf7-iBlKQ&start=20"
